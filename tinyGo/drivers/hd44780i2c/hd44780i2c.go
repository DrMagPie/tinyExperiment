...
// NOTE: Renamed it to align with Arduino lib
func (d *Device) send(value uint8, mode uint8) {
...
// NOTE: Exposed sendData and Rend Renamed it to align with Arduino lib
